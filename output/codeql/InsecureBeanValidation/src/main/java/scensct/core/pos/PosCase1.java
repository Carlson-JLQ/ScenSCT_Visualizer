    ...
    public static class MyConstraintValidator implements ConstraintValidator<MyConstraint, String> {
        ...
        public boolean isValid(String value, ConstraintValidatorContext context) {
            if (value == null || value.isEmpty()) {
                // Directly use unsanitized input in violation template
                String userInput = "unsafe"; // Simulated unsanitized input
                context.buildConstraintViolationWithTemplate("Error: " + userInput)
