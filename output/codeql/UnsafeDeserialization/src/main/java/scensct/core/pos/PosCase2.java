// Untrusted data flows into a deserialization sink via JsonIo reader (non-constructor barrier) and Jodd parse without typed class argument, no Flexjson calls.
...
public class PosCase2 {
    public void deserializeUntrustedData(InputStream untrustedStream) throws Exception {
        ...
        Object deserialized = parser.parse((String) intermediate); // Sink with tainted data
