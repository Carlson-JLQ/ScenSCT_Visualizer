// Untrusted data flows into a deserialization sink via JsonIo reader (non-constructor barrier) and Jodd parse with null type class argument, no Flexjson calls.
...
public class PosCase1 {
    public void deserializeUntrustedData(InputStream untrustedStream) throws Exception {
        ...
        Object deserialized = parser.parse((String) intermediate, null); // Sink with tainted data
